...
const Footer = () => {
  ...
  <Link href={"../servey"} className="  focus:border-blue-900 focus:outline-none  bg-teal-200 text-teal-900 focus:bg-blue-700 focus:text-slate-100 disabled">
  ...
  <Link href={"../reports"} className="  focus:border-blue-900 focus:outline-none  bg-rose-200 text-rose-900 focus:bg-blue-700 focus:text-slate-100 disabled">
